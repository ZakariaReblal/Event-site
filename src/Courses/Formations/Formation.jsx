    ...
    <div className="col-4 mt-5" key={i.id}>
      <div className="card hover-zoom">
        ...
        <div className="card-body text-center">
          ...
          <button className="btn btn-dark text-light fw-bold w-100" type="submit">{i.prix}<FontAwesomeIcon icon={faEuroSign} className="fa-sharp fa-regular fa-euro-sign" /></button> 
          </Link>
          </div>
