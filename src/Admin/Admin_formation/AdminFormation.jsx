...
const AdminFormation = () => {
  ...
  const deleteFormation = (_id) =>{
    ...
    .then((formation) => { 
      alert("Formation est Supprimer!", formation.title )
      getAllFormations();
    })
  ...
  <div class="card-body">
    <form onSubmit={handleSubmit}>
      <div class="form-group">
        <label for="title">Name Formation</label>
        ...
        <div className="card">
          ...
          <img src={i.image} class="card-img-top" alt="..."/>
            <div className="card-body text-center">
              ...
              <i>{i.duree} Mois</i> <FontAwesomeIcon icon={faCalendarWeek} className="fa-solid fa-calendar-week" /><br />
