...
const Admin_user = () => {
  ...
  const deleteUser=(_id ) => {
    ...
    .then((user) => { 
      alert("User est Supprimer!",user.fname,user.lname )
      getAllUsers();
    })
  }
    ...
    return (
          ...
          <NavAdmin/>
              ...
              <div class="div2">
                ...
                <div className="underline ml-1 mt-3"></div>
                ...
                {users.map(i=>{
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style={{ border: '1px solid #dddddd', padding: '8px' }}>{i.email}</td>
                      <td style={{ border: '1px solid #dddddd', padding: '8px' }}> <button class='btn btn-danger'onClick={()=>deleteUser(i._id)} >Supprimer</button> </td>
                    </tr>
                  </tbody>
