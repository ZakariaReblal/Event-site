...
const AdminEvent = () => {
  ...
  const deleteEvent = (_id) =>{
    ...
    .then((event) => { 
      alert("Evenement est Supprimer!", event.title )
      getAllEvents();
    })
    ...
    return (
        ...
        <div className='AdminEvent2'>
           ...
           <div class="card formulaire mt-4">
            ...
            <h1 className='fw-bold ml-3 text-center'style={{marginTop:"5rem"}}>Liste Events</h1>
              ...
              <div class="row g-0">
                ...
                <div class="col-8">
                  <div class="card-body ">
                    ...
                    <button class="btn btn-secondary " onClick={()=>getEvente(i._id)} style={{ marginLeft: "1rem" }}>Modifier</button>
                    {/* </Link> */}
                        <button class="btn btn-danger" onClick={()=>deleteEvent(i._id)} style={{ marginLeft: "1rem" }}>Supprimer</button>
                  </div>
                </div>
              </div>
            </div>
