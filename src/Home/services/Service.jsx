...
const Services = () => {
  ...
  const targetDivRef = useRef(null); // Référence à l'élément DOM cible
  const targetDivEvent = React.useRef(null);
  const myElementRef = useRef(null);

  useEffect(() => {
    // Initialiser AOS avec les options de configuration souhaitées
    AOS.init({
      // Exemple d'options de configuration:
      duration: 2000, // Durée de l'animation en millisecondes
      once: true, // L'animation ne se répète pas lors du défilement ultérieur
    });
    // Nettoyer AOS lors du démontage du composant
    return () => {
      AOS.refresh(); // Réinitialiser AOS
    };
  }, []);
        ...
        <div className="container abo">
          <div className="row g-5">
            ...
            <div className="col-lg-6 ss">
              ...
              <div className="underline1"></div>
              <h1 className="mb-4 mt-4 text-start fw-bold text-uppercase">BIENVENU à SIGMA</h1>
              <p className="mb-4">  
...
<div className="container actus">
          <div className="row g-5">
            ...
            <div className="col-lg-6 ac">
              ...
              <a href=""><h4 className="fw-bold">Association</h4></a>
              <p><i className="icon02"><FontAwesomeIcon icon={faCalendarWeek} className="fa-solid fa-calendar-week "/></i>  25/03/2024
              <i class="fa fa-clock text-dark ml-3"> 12:30</i></p>
              <p className="mt-1">Lorem ipsum dolor sit amet consectetur, rror repudiandae ab quo nobis nostrum. Neque placeat delectus repellendus quibusdam dolorem, sit nam quae voluptatem.</p>
              
              <a href=""><h4 className="fw-bold">Conference du Marketing</h4></a>
              <p><i className="icon02"><FontAwesomeIcon icon={faCalendarWeek} className="fa-solid fa-calendar-week "/></i>  25/03/2024
              <i class="fa fa-clock text-dark ml-3"> 12:30</i></p>
              <p className="mt-1">Lorem ipsum dolor sit amet consectetur, rror repudiandae ab quo nobis nostrum. Neque placeat delectus repellendus quibusdam dolorem, sit nam quae voluptatem.</p>
              
              <a href=""><h4 className="fw-bold">Colloque 2023</h4></a>
              <p><i className="icon02"><FontAwesomeIcon icon={faCalendarWeek} className="fa-solid fa-calendar-week "/></i>  25/03/2024
              <i class="fa fa-clock text-dark ml-3"> 12:30</i></p>
              <p className="mt-1">Lorem ipsum dolor sit amet consectetur, rror repudiandae ab quo nobis nostrum. Neque placeat delectus repellendus quibusdam dolorem, sit nam quae voluptatem.</p>
            </div>
...
<div className="container courses" >
  ...
  <div class="col-sm-4">
          <div class="card shadow-lg hover-zoom">
            <img src={about5} class="card-img-top hover-zoom_image" alt="..."/>
            <div class="card-body text-center">
            <h5 class="card-title fw-bold">Web Design</h5>
            <i>10 weeks</i>  <FontAwesomeIcon icon={faCalendarWeek} className="fa-solid fa-calendar-week"/><br />
        ...
        <button class="btn btn-dark text-light fw-bold" type="submit">50 <FontAwesomeIcon icon={faEuroSign} className="fa-sharp fa-regular fa-euro-sign" /></button>
        </div>
        </Link>
        <div class=" position-relative d-flex mt-2" >
         <small class="flex-fill text-center  py-2"><i class="fa fa-clock text-primary me-2"></i>3H/Days</small>
...
<div class="col-sm-4">
          <div class="card shadow-lg hover-zoom">
            ...
            <div className="text-center d-none d-sm-block" id="icons">
              ...
              <FontAwesomeIcon icon={faStar} className="fa-sharp fa-solid fa-star" style={{color: "#d1e916",}} /> 
              <FontAwesomeIcon icon={faStar} className="fa-sharp fa-solid fa-star" style={{color: "#d1e916",}} /> 
              <FontAwesomeIcon icon={faStar} className="fa-sharp fa-solid fa-star" style={{color: "#d1e916",}} />   (32)
            </div>
          <Link to="/Payment" target="_blank" className="text-decoration-none">     
        <div className="d-grid gap-2">
        <button class="btn btn-dark text-light fw-bold" type="submit">24.99 <FontAwesomeIcon icon={faEuroSign} className="fa-sharp fa-regular fa-euro-sign" /></button>
        </div>
        </Link>
        <div class=" position-relative d-flex mt-2" >
         <small class="flex-fill text-center  py-2"><i class="fa fa-clock text-primary me-2"></i>2H/Days</small>
...
<div class="col-sm-4">
          <div class="card shadow-lg hover-zoom">
            ...
            <i>12 Month</i>  <FontAwesomeIcon icon={faCalendarWeek} className="fa-solid fa-calendar-week"/><br />
            <div className="text-center d-none d-sm-block" id="icons">
              <FontAwesomeIcon icon={faStar} className="fa-sharp fa-solid fa-star" style={{color: "#d1e916",}} /> 
              <FontAwesomeIcon icon={faStar} className="fa-sharp fa-solid fa-star" style={{color: "#d1e916",}} /> 
              <FontAwesomeIcon icon={faStar} className="fa-sharp fa-solid fa-star" style={{color: "#d1e916",}} /> 
              <FontAwesomeIcon icon={faStar} className="fa-sharp fa-solid fa-star" style={{color: "#d1e916",}} /> 
              <FontAwesomeIcon icon={faStar} className="fa-sharp fa-solid fa-star" style={{color: "#d1e916",}} /> (25)
            </div>
  <Link to="/Payment" target="_blank" className="text-decoration-none">     
    <div className="d-grid gap-2">
     <button class="btn btn-dark text-light fw-bold" type="submit">99.99 <FontAwesomeIcon icon={faEuroSign} className="fa-sharp fa-regular fa-euro-sign" /></button>
    </div>
  </Link> 
        <div class=" position-relative d-flex mt-2" >
         <small class="flex-fill text-center  py-2"><i class="fa fa-clock text-primary me-2"></i>9H/Week</small>
