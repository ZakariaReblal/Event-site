...
<div class="row row-cols-1 row-cols-md-2">
  <div class=" col-md-6 mx-auto mt-5">
    <div class="card">
      <img src={colloque} class="card-img-top" alt="..."/>
      <div class="card-body">
        <h4 class="card-title text-center fw-bold">Table Rende</h4>
        <p class="card-text">This is a longer card with Lorem ipsum dolor sit, amet consectetur adipisicing elit. Velit hic distinctio sequi maiores. Fugit corrupti corporis eos maiores maxime. Aspernatur est maiores officia excepturi numquam sed! Officiis labore dolore et. supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
